...
<body>
  ...
  <button class="offcanvas__trigger--open btn" data-offcanvas-open="my-navigation"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/open.png" width="35" height="35"></button>
      ...
      <div class="box-con">
                ...
                <h2><a href="<?php bloginfo( 'url' ); ?>#fromID">Sell Points</a></h2>
          </div>
      <div class="box-con">
                ...
                <h2><a href="<?php bloginfo( 'url' ); ?>#fromID">Buy Points </a></h2>
          </div>
      <div class="box-con">
      ...
      <div class="box-con">
                ...
                <h2><a href="<?php bloginfo( 'url' ); ?>#WhyUs">Why Us?</a></h2>
          </div>
      <div class="box-con">
